...
class Subcribe():
    ...
    def __init__(self, app_client_id, app_client_secret, **kwargs):
        ...
        self.c = Cortex(app_client_id, app_client_secret, debug_mode=True, license='2ac1ecb5-bec6-4f61-93b6-8aeae0e9500f', **kwargs)
    ...
    def on_new_eeg_data(self, *args, **kwargs):
        ...
        allData.append(data.get('eeg'))
        pd.DataFrame(allData).to_csv('egg-data.csv', index_label="Index", header=["COUNTER","INTERPOLATED", "AF3", "T7", "Pz", "T8", "AF4", "RAW_CQ", "MARKER_HARDWARE"])
