...
def main():
    ...
    r.record_title = 'OneMinuteRecord'  # required param and can not be empty
    r.record_description = 'OneMinuteRecord_BrainWaves'  # optional param

    # input params for export_record. Please see on_warn_cortex_stop_all_sub()
    r.record_export_folder = "C:/Users/alika/Documents/hochschule/Bachelorarbeit/bci_ba" # your place to export, you should have write permission, example on desktop
    r.record_export_data_types = ['EEG']
    r.record_export_format = 'CSV'
    r.record_export_version = 'V2'

    record_duration_s = 60  # duration for recording in this example. It is not input param of create_record
